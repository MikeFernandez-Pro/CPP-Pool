...
/*   Updated: 2020/10/08 15:02:30 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap( void )
{
	...
	std::cout <<"FR4G-TP < \033[1;37m" << _Name << "> arrive sur la Grand-Place !" << "\033[0;m" << std::endl;
}
...
{
	std::cout <<"FR4G-TP < \033[1;37m" << this->_Name << "\033[0;m(\033[1;31m" << this->_HitPoints
	<< "\033[0;m-\033[1;33m" << this->_EnergyPoints << "\033[0;m) > s'enfuit le plus vite possible !" << std::endl;
}
...
void	FragTrap::rangedAttack(std::string const & target)
{
	...
	<< "> à distance, causant <" << this->_RangedAttackDamage << "> points de dégâts !" << std::endl;
}
...
void	FragTrap::meleeAttack(std::string const & target)
{
	std::cout <<  "FR4G-TP < \033[1;37m" << this->_Name << "\033[0;m(\033[1;31m" << this->_HitPoints
	<< "\033[0;m-\033[1;33m" << this->_EnergyPoints << "\033[0;m) > attaque <" << target
	<< "> au corps à corps, causant <" << this->_MeleeAttackDamage << "> points de dégâts !" << std::endl;
}
