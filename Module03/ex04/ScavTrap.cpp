...
/*   Updated: 2020/10/08 16:29:20 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap( void )
{
	...
	srand(time(NULL));
	std::cout <<"SC4V-TP < \033[1;37m" << _Name << "> arrive sur la Grand-Place !" << "\033[0;m" << std::endl;
}
...
ScavTrap::ScavTrap( std::string pName) : ClapTrap(pName)
{
	...
	this->_ArmorDamageReduction = 3;
	srand(time(NULL));
	std::cout <<"SC4V-TP < \033[1;37m" << this->_Name << "\033[0;m(\033[1;31m" << this->_HitPoints
