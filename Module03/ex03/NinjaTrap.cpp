...
{
	std::cout <<  "NINJ4-TP < \033[1;37m" << this->_Name << "\033[0;m(\033[1;31m" << this->_HitPoints
	<< "\033[0;m-\033[1;33m" << this->_EnergyPoints << "\033[0;m) > regarde son ami " << target.getName() << " le CL4P-TP fuir." << std::endl;
}
...
{
	std::cout <<  "NINJ4-TP < \033[1;37m" << this->_Name << "\033[0;m(\033[1;31m" << this->_HitPoints
	<< "\033[0;m-\033[1;33m" << this->_EnergyPoints << "\033[0;m) > regarde son ami " << target.getName() << " le FR4G-TP fuir." << std::endl;
}
...
{
	std::cout <<  "NINJ4-TP < \033[1;37m" << this->_Name << "\033[0;m(\033[1;31m" << this->_HitPoints
	<< "\033[0;m-\033[1;33m" << this->_EnergyPoints << "\033[0;m) > regarde son ami " << target.getName() << " le SC4V-TP fuir." << std::endl;
}
...
{
	std::cout <<  "NINJ4-TP < \033[1;37m" << this->_Name << "\033[0;m(\033[1;31m" << this->_HitPoints
	<< "\033[0;m-\033[1;33m" << this->_EnergyPoints << "\033[0;m) > regarde son ami " << target.getName() << " le NINJ4-TP fuir." << std::endl;
}
