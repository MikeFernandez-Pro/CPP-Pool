...
/*   Updated: 2020/10/08 19:34:42 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap( void )
{
	...
	srand(time(NULL));
	std::cout <<"CL4P-TP < \033[1;37m" << _Name << ">\033[0;m sort de sa cachette !"  << std::endl;
}
...
ClapTrap::ClapTrap( std::string pName)
{
	...
	<< "\033[0;m-\033[1;33m" << this->_EnergyPoints << "\033[0;m) > sort de sa cachette !" << std::endl;
}
